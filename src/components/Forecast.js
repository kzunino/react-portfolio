      ...
      <div className='container-fluid p-2'>
        <main className='container-fluid mt-5 px-0'>
          ...
          <p className='col-md-9 p-0 text-secondary'>
            Weather Forecast is a simple application I created after learning
            the basics of Bootstrap 4. I wanted a way to practice styling, while
            at the same time exercise my skills at managing large data sets from
            OpenWeatherMap API.
          </p>
        </main>
        ...
        <section className='container-fluid mt-5 px-0'>
          ...
          <div className='row justify-content-center'>
            <p className='col-md-9 text-center text-secondary'>
              One of the issues I had with this project was getting accurate
              icons to render for the correct weather patterns. The API doesn't
              use a numerical database to reference different weather patterns
              so I was forced to use their general descriptions such as "clear"
              or "rain" in order to render an icon. Because of this, there isn't
              great diversity in the icons used for different weather patterns.
              <br></br>
              <br></br>
              ...
              their zip code every time the page refreshes or loads. It's a
              slight hassle to constantly have to input a your zip code.
              Additionally, it would be awesome if this project could be global,
              however, it only accepts valid US zip codes.
              <br></br>
              <br></br>
